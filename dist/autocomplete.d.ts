...
export declare class GeocoderAutocomplete {
    ...
    private geocoderRequestVersion;
    private geocoderRequestPending;
    private currentPlaceDetailsPromiseReject?;
    private placeDetailsRequestVersion;
    private placeDetailsRequestPending;
    ...
    on(operation: GeocoderEventType, callback: (...params: any[]) => any): void;
    off(operation: GeocoderEventType, callback?: (...params: any[]) => any): void;
    once(operation: GeocoderEventType, callback: (...params: any[]) => any): void;
    ...
    setPostprocessHook(postprocessHookFunc?: ((feature: any) => string) | null): void;
    ...
    close(): void;
    open(): void;
    private validateFeatureCollectionResponse;
